...
class CoordinateSystem:
    ...
    def __init__(self, center_lat: float, center_lon: float):
        ...
        logging.debug(f"Created CoordinateSystem for ({center_lat:.6f}, {center_lon:.6f})")
...
def bounds_overlap(bounds1: Dict[str, float], bounds2: Dict[str, float]) -> bool:
    ...
    """
    return not (
        bounds1["xmax"] < bounds2["xmin"] or 
        bounds1["xmin"] > bounds2["xmax"] or
        bounds1["ymax"] < bounds2["ymin"] or 
